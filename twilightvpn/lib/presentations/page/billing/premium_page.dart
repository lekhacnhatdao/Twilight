        ...
        return GestureDetector(
          ...
          child: Container(
            decoration: BoxDecoration(
                ...
                //   ),
                // ),
                border: Border.all(width: 3, color:  state.selectedSubscription?.id == e.id ? Colors.red: Colors.transparent)),
              ...
              children: [
                ...
                state.selectedSubscription?.id == e.id
                    ...
                    : Text(
                        ...
                        ' ${e.price}',style: TextStyle( fontSize: 25,   color: AppColors.primary,),
